...
public class StatisticsPieForm extends BaseForm {
  
        
    private boolean drawOnMutableImage;
    private double nbr_reservation = 45;
    private double nbr_abonnement = 6;   
    
    Form current;
BaseForm form;
        public StatisticsPieForm(Resources res)  {
        ...
        addTab(swipe, res.getImage("salle-back.jpg"), spacer1, "Bienvenue");
        ...
        RadioButton all = RadioButton.createToggle("Reservation", barGroup);
       
        all.setUIID("SelectBar");
        RadioButton popular = RadioButton.createToggle("Categorie Abonnement", barGroup);
        popular.setUIID("SelectBar");
        RadioButton feedback = RadioButton.createToggle("Reservation", barGroup);
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutAbonnementForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        double total = nbr_reservation + nbr_abonnement;
        
        //values
        double prcntFeed = (nbr_reservation *100)/total;
        
        double prcntRec = (nbr_abonnement * 100)/total;
        ...
        String []messages = {
            "Statistique reservation % abonnements"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Abonnement",prcntRec);
        series.add("Reservation",prcntFeed);
