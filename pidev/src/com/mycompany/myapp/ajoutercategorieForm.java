...
public class ajoutercategorieForm extends BaseForm{
    ...
    public ajoutercategorieForm(Resources res){
       ...
       TextField nomcat = new TextField("","Enter le nom");
       nomcat.setUIID("TextFieldBlack");
       addStringValue("NomCat",nomcat);
       
      TextField img = new TextField("","Enter l'image ");
       ...
       addStringValue("", btnadd);
        ...
        btnadd.addActionListener((e)->{
            try{
                if(nomcat.getText() == "" && img.getText()=="" ){
                    Dialog.show("Veuillez verifier vos donnees","","", "OK");
                }
                else if(nomcat.getText().length()<3) {
                    Dialog.show("la longeur du nom doit ","etre superieur a 3",null, "OK");
                }
                    ...
                    Category cat=new Category(String.valueOf(nomcat.getText().toString()),String.valueOf(img.getText().toString()+".png"));
                    System.out.println("data categorie ==="+cat);
                    servicecategory.getInstance().ajoutercategorie(cat);
